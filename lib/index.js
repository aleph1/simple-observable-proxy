...
exports.destroy = exports.unobserve = exports.observe = exports.off = exports.on = exports.observable = exports.ObservableEvents = void 0;
exports.ObservableEvents = {
    change: 'change',
    destroy: 'destroy',
};
...
const on = (observableProxy, eventType, callback) => {
...
exports.on = on;
const off = (observableProxy, eventType, callback) => {
    const observers = observersByProxy.get(observableProxy);
...
const observe = (observableProxy, callback) => (0, exports.on)(observableProxy, exports.ObservableEvents.change, callback);
exports.observe = observe;
const unobserve = (observableProxy, callback) => (0, exports.off)(observableProxy, exports.ObservableEvents.change, callback);
